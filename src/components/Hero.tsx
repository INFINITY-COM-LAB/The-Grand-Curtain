...
export function Hero() {
  return (
    ...
    >
      ...
      {/* Spotlight effects */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-amber-500/5 rounded-full blur-[120px] pointer-events-none" aria-hidden="true" />
      <div className="absolute top-20 left-1/4 w-[300px] h-[300px] bg-red-900/10 rounded-full blur-[100px] pointer-events-none" aria-hidden="true" />
      <div className="absolute top-20 right-1/4 w-[300px] h-[300px] bg-red-900/10 rounded-full blur-[100px] pointer-events-none" aria-hidden="true" />
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="#now-showing"
            className="w-full sm:w-auto rounded-full bg-gradient-to-r from-amber-500 to-yellow-500 px-10 py-4 text-base font-bold uppercase tracking-wider text-black hover:from-amber-400 hover:to-yellow-400 transition-all duration-300 shadow-lg shadow-amber-500/25 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-offset-2 focus:ring-offset-black"
          >
            View Current Shows
          </a>
          <a
            href="#about"
            className="w-full sm:w-auto rounded-full border border-white/20 bg-white/5 px-10 py-4 text-base font-semibold uppercase tracking-wider text-white hover:bg-white/10 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white/30 focus:ring-offset-2 focus:ring-offset-black"
          >
            Explore the Theatre
          </a>
        </div>
        ...
        {/* Stats */}
        <div className="mt-16 grid grid-cols-3 gap-8 max-w-lg mx-auto" role="list" aria-label="Theatre statistics">
          {stats.map((stat) => (
      ...
      <a
        href="#now-showing"
        className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/30 hover:text-amber-400 transition-colors focus:outline-none focus:text-amber-400"
        aria-label="Scroll to Now Showing"
      >
